  ...
  const std::string &_str)
{
  ...
  cerr << "SurfaceType string not recognized, "
...
void SphericalCoordinates::SetSurfaceType(const SurfaceType &_type)
{
  ...
  switch (this->dataPtr->surfaceType)
  {
    ...
    default:
      cerr << "Unknown surface type[" << this->dataPtr->surfaceType << "]\n";
      break;
  }
}
    ...
    const CoordinateType &_in, const CoordinateType &_out) const
{
  ...
  switch (_in)
  {
    ...
    case ECEF:
      break;
    default:
      cerr << "Invalid coordinate type[" << _in << "]\n";
      return _pos;
  }
  ...
  switch (_out)
  {
    ...
    default:
      cerr << "Unknown coordinate type[" << _out << "]\n";
      return _pos;
  }
    ...
    const CoordinateType &_in, const CoordinateType &_out) const
{
  ...
  {
    cout << "Spherical velocities are not supported";
    return _vel;
  }
  ...
  switch (_in)
  {
    ...
    case ECEF:
      ...
      break;
    default:
      cerr << "Unknown coordinate type[" << _in << "]\n";
      return _vel;
  }
